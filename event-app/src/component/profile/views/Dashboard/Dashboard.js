...
import FileUploadthree from "./FileUploadthree"
...
function Dashboard(props) {
  ...
  const updateImagesmap = (newImages) => {
    setImage(newImages.value);
    setSave({ ...save,imagemap: newImages });
  };
  useEffect(() => {
    setSave(props.save);
  }, [props.save]);
        ...
        >
          <GridContainer>
            <GridItem xs={12} sm={12} md={12}>
              <Card>
                <Form>
                  <div className="row"><p style={{color:"grey" ,marginLeft:"50px",marginTop:"50px"}}>
                    photos d'évènements</p>
                    <p style={{color:"grey" ,marginLeft:"240px",marginTop:"50px"}}>
                   map image</p>
                    </div>
                  <div className="row">
                  <div
